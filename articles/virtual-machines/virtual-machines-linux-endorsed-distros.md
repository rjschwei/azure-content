...
SUSE Linux Enterprise | SLES 11 SP4, SLES 12+ and <p> SLES for SAP 12+ | In Kernel | Package: Part of the Public Cloud Module repository "python-azure-agent" <br/>Source Code: [GitHub](http://go.microsoft.com/fwlink/p/?LinkID=250998)
